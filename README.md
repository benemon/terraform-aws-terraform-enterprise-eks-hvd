...
| <a name="input_eks_nodegroup_volume_iops"></a> [eks\_nodegroup\_volume\_iops](#input\_eks\_nodegroup\_volume\_iops) | The iops of the volume provisioned for each node group member | `number` | `3000` | no |
| <a name="input_eks_nodegroup_volume_size"></a> [eks\_nodegroup\_volume\_size](#input\_eks\_nodegroup\_volume\_size) | The size of volume to provision for each node group member | `number` | `20` | no |
| <a name="input_eks_nodegroup_volume_throughput"></a> [eks\_nodegroup\_volume\_throughput](#input\_eks\_nodegroup\_volume\_throughput) | The throughput of the volume provisioned for each node group member | `number` | `125` | no |
| <a name="input_eks_nodegroup_volume_type"></a> [eks\_nodegroup\_volume\_type](#input\_eks\_nodegroup\_volume\_type) | The type of volume to provision for each node group member | `string` | `"gp3"` | no |
